...
public class ProgressAppGlideModule extends AppGlideModule {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .addNetworkInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        ProgressAppGlideModule.ResponseProgressListener listener = new ProgressAppGlideModule.DispatchingProgressListener();
                        return response.newBuilder()
                                .body(new ProgressAppGlideModule.OkHttpProgressResponseBody(request.url(), response.body(), listener))
                                .build();
                    }
                })
                .build();
    ...
    private static class DispatchingProgressListener implements ProgressAppGlideModule.ResponseProgressListener {
        ...
        static void expect(String url, ProgressAppGlideModule.UIonProgressListener listener) {
        ...
        public void update(HttpUrl url, final long bytesRead, final long contentLength) {
            ...
            final ProgressAppGlideModule.UIonProgressListener listener = LISTENERS.get(key);
            if (listener == null) {
                return;
            }
    ...
    private static class OkHttpProgressResponseBody extends ResponseBody {
        ...
        private final ProgressAppGlideModule.ResponseProgressListener progressListener;
        private BufferedSource bufferedSource;

        OkHttpProgressResponseBody(HttpUrl url, ResponseBody responseBody,
                                   ProgressAppGlideModule.ResponseProgressListener progressListener) {
            this.url = url;
